package com.jay.storymirror.ui.recommendations
...
class RecommendationsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.recycler_view_recommendations_stories)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.getRecommendationsStories().observe(this, Observer {
